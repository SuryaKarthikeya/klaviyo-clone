    ...
    <>
      ...
      {logoStrip && (
        <motion.div
          ...
          className="bg-realify-bg border-b border-gray-200 py-20"
        >
          <div className="max-w-[1400px] mx-auto px-6 text-center">
            <p className="text-sm font-bold text-gray-500 uppercase mb-12 tracking-widest">
              {logoStrip.label}
            </p>
                ...
                return (
                  <a key={logo._id || index} href={logo.url} target="_blank" rel="noreferrer">
                    <img
                      src={logo.imageUrl}
                      alt={logo.name}
                      className="h-10 md:h-14 w-auto object-contain opacity-40 grayscale hover:opacity-70 hover:grayscale-0 transition-all duration-500"
